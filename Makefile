...
.PHONY: serve-easy serve-medium-server-1 test build-easy-server build-medium-server-1 build-compare-csv build-process-products build-shuffle-csv build-all
...
build-all: build-easy-server build-medium-server-1 build-compare-csv build-process-products build-shuffle-csv
